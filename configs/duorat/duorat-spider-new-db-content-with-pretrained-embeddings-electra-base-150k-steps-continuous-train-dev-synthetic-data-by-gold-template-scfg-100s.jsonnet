(import 'duorat-finetune-bert-large.jsonnet') {
    local PREFIX = 'data/',
    data: {
        name: 'Spider_by_synthetic_data_v5_by_gold_template_scfg_100s',
        train: (import '../../data/val_by_synthetic_data_v5_by_gold_template_scfg_100s.libsonnet')(prefix=PREFIX),
