...
if __name__ == "__main__":
    ...
    pseudo_data_config = '/mnt/a99/d0/awasthi/repos/Text2SQL/duoleo/data/train.libsonnet' 
    data_config = json.loads(_jsonnet.evaluate_file(
        pseudo_data_config, tla_codes={'prefix': '"data/"'}))
    if data_config['name'] != 'spider':
        raise ValueError()
    del data_config['name']
    
    data_config['paths'] = [args.questions]
    data_config['db_path'] = args.database_path
    data_config['tables_paths'] = [args.tables_path]
