...
DATABASE_DIR=$CODE/data/database
...
function gdrive_download_py {
    python $CODE/scripts/download_data_from_gdrive_link.py $1 $2
}
...
function create_sqlite_db { 
    ...
    bash -x $CODE/scripts/mysql2sqlite_no_docker.sh ${DB}_test/$SQL_FILE ${DB}_test/${DB}_test.sqlite $CODE
...
function create_schema_file {
    ...
    python $CODE/scripts/get_tables_new.py\
        $DATABASE_DIR/${DB}_test/${DB}_test.sqlite\
        $DATABASE_DIR/${DB}_test/tables.json
    python $CODE/scripts/add_foreign_keys_michigan.py ${DB} $DATABASE_DIR/${DB}_test/tables.json
}
...
function go_geo {
    ...
    wget $MICHIGAN_GITHUB/data/geography-db.added-in-2020.sqlite || exit
    mv geography-db.added-in-2020.sqlite geo_test.sqlite
...
function go_atis {
    ...
    wget $MICHIGAN_GITHUB/data/atis-db.added-in-2020.sqlite || exit
    mv atis-db.added-in-2020.sqlite atis_test.sqlite
...
function go_academic {
    ...
    gdrive_download_py 0B-2uoWxAwJGKbnBCdkJGcHc5dDQ academic.sql
    ...
    sqlite3 $DATABASE_DIR/academic_test/academic_test.sqlite <<HEREDOC_EOF
...
function go_restaurants { 
    ...
    wget $MICHIGAN_GITHUB/data/restaurants-db.added-in-2020.sqlite || exit
    mv restaurants-db.added-in-2020.sqlite restaurants_test.sqlite
...
function go_yelp {
    ...
    gdrive_download_py 0B-2uoWxAwJGKX09Ld1RhVW5NbVk yelp.sql || exit
    ...
    sqlite3 $DATABASE_DIR/yelp_test/yelp_test.sqlite << HEREDOC_EOF
...
function go_imdb {
    ...
    gdrive_download_py 0B-2uoWxAwJGKNkFGZHFCQ29yNWM imdb.sql || exit
    ...
    sqlite3 $DATABASE_DIR/imdb_test/imdb_test.sqlite << HEREDOC_EOF
...
function go_scholar {
    ...
    gdrive_download_py 0Bw5kFkY8RRXYRXdYYlhfdXRlTVk scholar.zip || exit
    unzip scholar.zip
...
sqlite3 $DATABASE_DIR/scholar_test/scholar_test.sqlite <<HEREDOC_EOF
...
function go_advising {
    ...
    wget $MICHIGAN_GITHUB/data/advising-db.added-in-2020.sqlite || exit
    mv advising-db.added-in-2020.sqlite advising_test.sqlite
