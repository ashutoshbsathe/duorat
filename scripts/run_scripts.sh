...
# 100 samples
python scripts/data_aug/collect_synthetic_data_template_scfg.py --file-type json --files-folder-path /mnt/shared/parthur/experiments/nl2sql/output/data/databases/v5_mono/spider/database --output-data-file ./data/spider/spider_all_dbs_synthetic_data_v5_mono_nl_by_t5_gen_100s.json --samples-by-db 50
...
# 200 samples
python scripts/data_aug/collect_synthetic_data_template_scfg.py --file-type json --files-folder-path /mnt/shared/parthur/experiments/nl2sql/output/data/databases/v5_mono/spider/database --output-data-file ./data/spider/spider_all_dbs_synthetic_data_v5_mono_nl_by_t5_gen_200s.json --samples-by-db 50
