...
python scripts/data_aug/collect_synthetic_data_from_tsv_files.py --tsv-files-folder-path /mnt/shared/parthur/experiments/nl2sql/output/data/v1/spider --output-data-file ./data/spider/train_synthetic_data_by_template_scfg.json --samples-by-level 100
