...
# continuous train on original training data + ./data/spider/dev_with_car_1_train.json
...
python -m third_party.spider.evaluation --gold ./data/spider/dev_with_car_1_test_gold.sql --pred ./logdir/duorat-spider-new-db-content-with-pretrained-embeddings-electra-base-150k-steps-continuous-train-dev-with-car-1/dev-with-car-1-test-duorat-spider-new-db-content-with-pretrained-embeddings-electra-base-150k-steps-continuous-train-dev-with-car-1.output.txt --etype match --db ./data/database --table ./data/spider/tables.json
